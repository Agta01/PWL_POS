...
class PenjualanController extends Controller
{
    ...
    {
        $penjualans = PenjualanModel::select('penjualan_id', 'user_id', 'pembeli', 'penjualan_kode', 'penjualan _tanggal')->with('user');
      if ($request->user_id) {
    ...
    public function store_ajax(Request $request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                ...
                'penjualan _tanggal' => 'required|date_format:Y-m-d\TH:i'
            ];
